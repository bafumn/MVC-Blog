...
INSERT INTO `users` (`id`, `username`, `firstName`, `lastName`, `role`, `created_at`, `email`, `password`) VALUES
(1, 'bafumn', 'Vlad', 'Kor', 'admin', 1616060682, 'vlad@gmail.com', '$2y$10$nqCOHXKN0daYtONUQjqR4etLhzbk3nE60PT/IQRrUqbz5PDR4KOLO');
